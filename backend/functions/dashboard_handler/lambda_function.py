"""DashboardHandler Lambda entry point.

Serves the FastAPI application (from the shared layer) via Mangum.
API Gateway routes dashboard, admin, purchase-orders, goods-receipts,
and invoice detail/list/approve paths to this function.
